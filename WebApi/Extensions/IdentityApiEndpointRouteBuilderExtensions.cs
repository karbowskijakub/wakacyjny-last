...
using wakacyjny_last.Infrastructure.Resources.Templates;
using wakacyjny_last.WebApi.Models;
using wakacyjny_last.WebApi.Models.Registration;
...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        routeGroup.MapPost("/register", async Task<Results<Ok, ValidationProblem>>
            ...
            ([FromBody] RegistrationRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            var userManager = sp.GetRequiredService<UserManager<TUser>>();
            var userDataService = sp.GetRequiredService<IUserDataService>();
            ...
            ([FromBody] LoginRequest login, [FromQuery] bool? useCookies, [FromQuery] bool? useSessionCookies, [FromServices] IServiceProvider sp) =>
        {
            ...
            if (!await userManager.IsEmailConfirmedAsync(user))
            {
                var problemDetails = new ProblemDetails
                {
                    ...
                    Detail = "You must have a confirmed email to log in."
                };
        ...
        routeGroup.MapPost("/checkEmailExists", async Task<IResult> (CheckEmailRequest checkRequest, UserManager<TUser> userManager) =>
        {
        ...
        ([FromBody] ForgotPasswordRequest resetRequest, [FromServices] IServiceProvider sp) =>
        {
            ...
            if (user is not null && await userManager.IsEmailConfirmedAsync(user))
            {
                ...
                var userData = await userDataService.GetCurrentUserAsync(userId);
                ...
                var emailRequest = new EmailRequest
                {
                    ...
                    Body = ResetPasswordTemplate.GeneratePasswordResetEmailBody(firstName, resetPasswordUrl)
                };
        ...
        async Task SendConfirmationEmailAsync(TUser user, UserManager<TUser> userManager, HttpContext context, string email, bool isChange = false)
        {
            ...
            var emailRequest = new EmailRequest
            {
                ...
                Body = EmailConfirmationTemplate.GenerateConfirmationEmailBody(userFirstName, confirmEmailUrl)
            };
